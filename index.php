...
<header class="entete-site">
    ...
    <nav class="nav-utilisateur">
        ...
        <?php if (est_connecte()): ?>
            ...
            <a href="deconnexion.php" class="bouton-detail">
                Déconnexion
            </a>

        <?php else: ?>

            <a href="login.php" class="bouton-detail">
                Connexion
            </a>
        ...
        <section class="detail-evenement" id="panneau-ajout-evenement" hidden>
            ...
            <form id="formulaire-ajout-evenement">
                ...
                <section class="filtre">
                    ...
                    <select id="ville-ajout"></select>
                </section>

                <section class="filtre">
                    <label for="categorie-ajout">Catégorie :</label>
                    <select id="categorie-ajout"></select>
                </section>

                <section class="filtre">
                    <label for="public-ajout">Public :</label>
                    <select id="public-ajout"></select>
                </section>
...
<footer class="pied-page">
    ...
    <p>
        Travail réalisé par : Patrick Sanjab et Macil Timeridjine
    </p>

</footer>

<script>
    const EST_ADMIN = <?= est_admin() ? 'true' : 'false' ?>;
</script>
